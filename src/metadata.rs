...
use crate::validation::priority::migrate_string_priority;
...
pub struct CommonMetadata {
    ...
    /// Default to 0 for backward compatibility with legacy entities.
    #[serde(default)]
...
/// This enables backward compatibility with existing entities that use string priorities.
pub fn deserialize_priority<'de, D>(deserializer: D) -> Result<u32, D::Error>
where
    D: Deserializer<'de>,
{
